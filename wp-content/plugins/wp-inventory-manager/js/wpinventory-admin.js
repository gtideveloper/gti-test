...
jQuery( function ( $ ) {
  ...
  var container_height = $( "div.list_available" ).height();

  $( ".inventorywrap div.lists" ).css( { "min-height": container_height } );

  $( "div.list_selected h3" ).on( "click change", function () {

    $( "div.lists .list" ).each( function () {
      $( this ).removeClass( "current_selection" );
    } );

    $( this ).closest( "div.lists" ).addClass( "has_selection" );
    $( this ).closest( "div.list" ).toggleClass( "current_selection" );
  } )
} );
