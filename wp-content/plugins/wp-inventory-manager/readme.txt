...
= 2.0.2 =
2.0.2 Contains an update that could break your site if you use shortcodes with arguments that contain commas (eg, [wpinventory inventory_id="1,2,3"])

Before upgrading, please review the [Changelog for version 2.0.1](https://www.wpinventory.com/release-version-2-0-1)
