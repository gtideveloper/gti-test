...
//		if ( self::$args['category_id'] && stripos( self::$args['category_id'], self::ARGUMENT_SEPARATOR ) ) {
//			self::$args['category_id'] = explode( self::ARGUMENT_SEPARATOR, self::$args['category_id'] );
//		}

//		if ( self::$args['product_id'] && stripos( self::$args['product_id'], self::ARGUMENT_SEPARATOR ) ) {
//			self::$args['product_id'] = explode( self::ARGUMENT_SEPARATOR, self::$args['product_id'] );
//		}

//		if ( self::$args['order'] && stripos( self::$args['order'], self::ARGUMENT_SEPARATOR ) ) {
//			self::$args['order'] = explode( self::ARGUMENT_SEPARATOR, self::$args['order'] );
//		}
