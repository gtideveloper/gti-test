 ...
 * @final
 */
final class Category extends FieldArgsMetabox
{
    use Singleton;
    ...
    public static function renderOptions($args, $field)
    {
        ...
        $options = CategoryField::fetchFieldOptions($field);
        ?>
        <div
    ...
    public static function getFields()
    {
        ...
        $allowMultipleField             = [
            'before_row' => '<div class="c-field-type-args up-s-hidden" data-type="category">',
        ...
        $optionsType_id          = 'args:root_id';
        $optionsType             = [
            'after_row'        => '</div>',
            'name'             => __('Root Category', 'upstream-custom-fields'),
            'desc'             => __('Parent category to retrieve all children from.', 'upstream-custom-fields'),
            'id'               => $idPrefix . $optionsType_id,
            'type'             => 'select',
            'show_option_none' => true,
            'options'          => [],
            'options_cb'       => ['\\UpStream\\Plugins\\CustomFields\\Fields\\Category', 'fetchFieldOptions'],
        ];
        $fields[$optionsType_id] = $optionsType;
