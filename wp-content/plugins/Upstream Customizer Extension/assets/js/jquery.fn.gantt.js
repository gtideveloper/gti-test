...
(function ($, undefined) {
    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
                ...
                $.each(element.data, function (i, entry) {
                   // console.log(entry);
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        ...
                        entries.push(
                            '<div class="row milestone row' + i +
                            (entry.task ? ' sml' : (' fn-wide '+dataId)) +
                            '" id="rowheader' + i +
                        ...
                        if (entry.task) {
                            ...
                            entries.push(
                                '<div class="row task row' + i +
                                ' " id="RowdId_' + i + dataId + '">' +
                                '<span class="fn-label">' +
                                entry.task +
                                '</span>' +
                                '<span class="fn-assigned">' +
                                entry.assigned_to +
                                '</span>' +
                                '</div>'
                            );
            ...
            createProgressBar: function (days, progress, label, desc, color, dataObj) {
                ...
                var bar = $(
                    '<div style="background: ' + color + '" class="bar" data-content="' + desc + '">' +
                    ...
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            case "hours":
                                ...
                                _bar = core.createProgressBar(dl, day.progress, day.label, day.desc, day.color, day.dataObj);
