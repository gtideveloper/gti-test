...
The following is a set of guidelines for contributing to Copy Project plugin. Use your best judgment, and feel free to propose changes to this document in a pull request.

## How can I contribute?
### Reporting Bugs
A bug is a demonstrable problem caused by code in the repository.
Before creating bug reports, please check our [bug list](https://github.com/upstreamplugin/Copy-Project/issues?q=is%3Aopen+is%3Aissue+label%3Atype%3Aissue%3Abug), as the bug might be already be known.
...
Before creating enhancement suggestions, please check our [issues list](https://github.com/upstreamplugin/Copy-Project/issues), as the enhancement might be already known.
...
- Fill in the [required template](https://github.com/upstreamplugin/Copy-Project/blob/master/.github/PULL_REQUEST_TEMPLATE.md).
